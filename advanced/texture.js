...
raycast.texture = (function () {
    function load(id){
        ...
        var image = document.createElement(id);
    ...
    function startLoad(textures, onSuccess){
        ...
        for(var i = 0; i<n; i++){
            var image = new Image();
            //ERASE THIS AT THE RELEASE!!
            image.crossOrigin = "anonymous";//<-- YEAH THIS!!!
    ...
    return {load: load, startLoad: startLoad, getTextures: getTextures};
})();
